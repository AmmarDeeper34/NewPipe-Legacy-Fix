.class public Lorg/schabi/newpipe/local/subscription/SubscriptionFragment$$StateSaver;
.super Lorg/schabi/newpipe/fragments/BaseStateFragment$$StateSaver;
.source "SubscriptionFragment$$StateSaver.java"
...
.annotation system Ldalvik/annotation/Signature;
    value = {
        "<T:",
        "Lorg/schabi/newpipe/local/subscription/SubscriptionFragment;",
        ">",
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lorg/schabi/newpipe/local/subscription/SubscriptionFragment$$StateSaver;->BUNDLERS:Ljava/util/HashMap;

    .line 43
    new-instance v1, Lcom/evernote/android/state/InjectionHelper;

    const-string v2, "org.schabi.newpipe.local.subscription.SubscriptionFragment$$StateSaver"

    invoke-direct {v1, v2, v0}, Lcom/evernote/android/state/InjectionHelper;-><init>(Ljava/lang/String;Ljava/util/Map;)V

    sput-object v1, Lorg/schabi/newpipe/local/subscription/SubscriptionFragment$$StateSaver;->HELPER:Lcom/evernote/android/state/InjectionHelper;
...
.method public bridge synthetic restore(Ljava/lang/Object;Landroid/os/Bundle;)V
    ...
    .line 40
    check-cast p1, Lorg/schabi/newpipe/local/subscription/SubscriptionFragment;

    invoke-virtual {p0, p1, p2}, Lorg/schabi/newpipe/local/subscription/SubscriptionFragment$$StateSaver;->restore(Lorg/schabi/newpipe/local/subscription/SubscriptionFragment;Landroid/os/Bundle;)V
...
.method public restore(Lorg/schabi/newpipe/local/subscription/SubscriptionFragment;Landroid/os/Bundle;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(TT;",
    ...
    .line 60
    sget-object v0, Lorg/schabi/newpipe/local/subscription/SubscriptionFragment$$StateSaver;->HELPER:Lcom/evernote/android/state/InjectionHelper;

    const-string v1, "feedGroupsCarouselState"
    ...
    iput-object v1, p1, Lorg/schabi/newpipe/local/subscription/SubscriptionFragment;->feedGroupsCarouselState:Landroid/os/Parcelable;
    ...
    iput-object p2, p1, Lorg/schabi/newpipe/local/subscription/SubscriptionFragment;->itemsListState:Landroid/os/Parcelable;
...
.method public bridge synthetic save(Ljava/lang/Object;Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0, p1, p2}, Lorg/schabi/newpipe/local/subscription/SubscriptionFragment$$StateSaver;->save(Lorg/schabi/newpipe/local/subscription/SubscriptionFragment;Landroid/os/Bundle;)V
...
.method public save(Lorg/schabi/newpipe/local/subscription/SubscriptionFragment;Landroid/os/Bundle;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(TT;",
    ...
    iget-object v2, p1, Lorg/schabi/newpipe/local/subscription/SubscriptionFragment;->feedGroupsCarouselState:Landroid/os/Parcelable;
    ...
    iget-object p1, p1, Lorg/schabi/newpipe/local/subscription/SubscriptionFragment;->itemsListState:Landroid/os/Parcelable;
