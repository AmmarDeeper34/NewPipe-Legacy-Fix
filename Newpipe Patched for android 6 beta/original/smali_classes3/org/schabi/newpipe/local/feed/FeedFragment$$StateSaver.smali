.class public Lorg/schabi/newpipe/local/feed/FeedFragment$$StateSaver;
.super Lorg/schabi/newpipe/fragments/BaseStateFragment$$StateSaver;
.source "FeedFragment$$StateSaver.java"
...
.annotation system Ldalvik/annotation/Signature;
    value = {
        "<T:",
        "Lorg/schabi/newpipe/local/feed/FeedFragment;",
        ">",
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lorg/schabi/newpipe/local/feed/FeedFragment$$StateSaver;->BUNDLERS:Ljava/util/HashMap;

    .line 43
    new-instance v1, Lcom/evernote/android/state/InjectionHelper;

    const-string v2, "org.schabi.newpipe.local.feed.FeedFragment$$StateSaver"

    invoke-direct {v1, v2, v0}, Lcom/evernote/android/state/InjectionHelper;-><init>(Ljava/lang/String;Ljava/util/Map;)V

    sput-object v1, Lorg/schabi/newpipe/local/feed/FeedFragment$$StateSaver;->HELPER:Lcom/evernote/android/state/InjectionHelper;
...
.method public bridge synthetic restore(Ljava/lang/Object;Landroid/os/Bundle;)V
    ...
    .line 40
    check-cast p1, Lorg/schabi/newpipe/local/feed/FeedFragment;

    invoke-virtual {p0, p1, p2}, Lorg/schabi/newpipe/local/feed/FeedFragment$$StateSaver;->restore(Lorg/schabi/newpipe/local/feed/FeedFragment;Landroid/os/Bundle;)V
...
.method public restore(Lorg/schabi/newpipe/local/feed/FeedFragment;Landroid/os/Bundle;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(TT;",
    ...
    .line 59
    sget-object v0, Lorg/schabi/newpipe/local/feed/FeedFragment$$StateSaver;->HELPER:Lcom/evernote/android/state/InjectionHelper;
    ...
    iput-object p2, p1, Lorg/schabi/newpipe/local/feed/FeedFragment;->listState:Landroid/os/Parcelable;
...
.method public bridge synthetic save(Ljava/lang/Object;Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0, p1, p2}, Lorg/schabi/newpipe/local/feed/FeedFragment$$StateSaver;->save(Lorg/schabi/newpipe/local/feed/FeedFragment;Landroid/os/Bundle;)V
...
.method public save(Lorg/schabi/newpipe/local/feed/FeedFragment;Landroid/os/Bundle;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(TT;",
    ...
    iget-object p1, p1, Lorg/schabi/newpipe/local/feed/FeedFragment;->listState:Landroid/os/Parcelable;
