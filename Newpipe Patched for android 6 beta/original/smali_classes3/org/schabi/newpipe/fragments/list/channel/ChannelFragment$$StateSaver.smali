.class public Lorg/schabi/newpipe/fragments/list/channel/ChannelFragment$$StateSaver;
.super Lorg/schabi/newpipe/fragments/BaseStateFragment$$StateSaver;
.source "ChannelFragment$$StateSaver.java"
...
.annotation system Ldalvik/annotation/Signature;
    value = {
        "<T:",
        "Lorg/schabi/newpipe/fragments/list/channel/ChannelFragment;",
        ">",
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lorg/schabi/newpipe/fragments/list/channel/ChannelFragment$$StateSaver;->BUNDLERS:Ljava/util/HashMap;

    .line 43
    new-instance v1, Lcom/evernote/android/state/InjectionHelper;

    const-string v2, "org.schabi.newpipe.fragments.list.channel.ChannelFragment$$StateSaver"

    invoke-direct {v1, v2, v0}, Lcom/evernote/android/state/InjectionHelper;-><init>(Ljava/lang/String;Ljava/util/Map;)V

    sput-object v1, Lorg/schabi/newpipe/fragments/list/channel/ChannelFragment$$StateSaver;->HELPER:Lcom/evernote/android/state/InjectionHelper;
...
.method public bridge synthetic restore(Ljava/lang/Object;Landroid/os/Bundle;)V
    ...
    .line 40
    check-cast p1, Lorg/schabi/newpipe/fragments/list/channel/ChannelFragment;

    invoke-virtual {p0, p1, p2}, Lorg/schabi/newpipe/fragments/list/channel/ChannelFragment$$StateSaver;->restore(Lorg/schabi/newpipe/fragments/list/channel/ChannelFragment;Landroid/os/Bundle;)V
...
.method public restore(Lorg/schabi/newpipe/fragments/list/channel/ChannelFragment;Landroid/os/Bundle;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(TT;",
    ...
    .line 61
    sget-object v0, Lorg/schabi/newpipe/fragments/list/channel/ChannelFragment$$StateSaver;->HELPER:Lcom/evernote/android/state/InjectionHelper;
    ...
    iput-object v1, p1, Lorg/schabi/newpipe/fragments/list/channel/ChannelFragment;->name:Ljava/lang/String;
    ...
    iput v1, p1, Lorg/schabi/newpipe/fragments/list/channel/ChannelFragment;->serviceId:I
    ...
    iput-object p2, p1, Lorg/schabi/newpipe/fragments/list/channel/ChannelFragment;->url:Ljava/lang/String;
...
.method public bridge synthetic save(Ljava/lang/Object;Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0, p1, p2}, Lorg/schabi/newpipe/fragments/list/channel/ChannelFragment$$StateSaver;->save(Lorg/schabi/newpipe/fragments/list/channel/ChannelFragment;Landroid/os/Bundle;)V
...
.method public save(Lorg/schabi/newpipe/fragments/list/channel/ChannelFragment;Landroid/os/Bundle;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(TT;",
    ...
    iget-object v2, p1, Lorg/schabi/newpipe/fragments/list/channel/ChannelFragment;->name:Ljava/lang/String;
    ...
    iget v2, p1, Lorg/schabi/newpipe/fragments/list/channel/ChannelFragment;->serviceId:I
    ...
    iget-object p1, p1, Lorg/schabi/newpipe/fragments/list/channel/ChannelFragment;->url:Ljava/lang/String;
