...
.method static constructor <clinit>()V
    ...
    .line 22
    new-instance v1, Lorg/schabi/newpipe/extractor/stream/DeliveryMethod;

    const-string v3, "DASH"

    const/4 v4, 0x1

    invoke-direct {v1, v3, v4}, Lorg/schabi/newpipe/extractor/stream/DeliveryMethod;-><init>(Ljava/lang/String;I)V

    sput-object v1, Lorg/schabi/newpipe/extractor/stream/DeliveryMethod;->DASH:Lorg/schabi/newpipe/extractor/stream/DeliveryMethod;

    .line 32
    new-instance v3, Lorg/schabi/newpipe/extractor/stream/DeliveryMethod;

    const-string v5, "HLS"

    const/4 v6, 0x2

    invoke-direct {v3, v5, v6}, Lorg/schabi/newpipe/extractor/stream/DeliveryMethod;-><init>(Ljava/lang/String;I)V

    sput-object v3, Lorg/schabi/newpipe/extractor/stream/DeliveryMethod;->HLS:Lorg/schabi/newpipe/extractor/stream/DeliveryMethod;

    .line 42
    new-instance v5, Lorg/schabi/newpipe/extractor/stream/DeliveryMethod;

    const-string v7, "SS"

    const/4 v8, 0x3

    invoke-direct {v5, v7, v8}, Lorg/schabi/newpipe/extractor/stream/DeliveryMethod;-><init>(Ljava/lang/String;I)V

    sput-object v5, Lorg/schabi/newpipe/extractor/stream/DeliveryMethod;->SS:Lorg/schabi/newpipe/extractor/stream/DeliveryMethod;

    .line 52
    new-instance v7, Lorg/schabi/newpipe/extractor/stream/DeliveryMethod;

    const-string v9, "TORRENT"

    const/4 v10, 0x4

    invoke-direct {v7, v9, v10}, Lorg/schabi/newpipe/extractor/stream/DeliveryMethod;-><init>(Ljava/lang/String;I)V

    sput-object v7, Lorg/schabi/newpipe/extractor/stream/DeliveryMethod;->TORRENT:Lorg/schabi/newpipe/extractor/stream/DeliveryMethod;

    const/4 v9, 0x5

    .line 7
    new-array v9, v9, [Lorg/schabi/newpipe/extractor/stream/DeliveryMethod;
    ...
    sput-object v9, Lorg/schabi/newpipe/extractor/stream/DeliveryMethod;->$VALUES:[Lorg/schabi/newpipe/extractor/stream/DeliveryMethod;
...
.method public static valueOf(Ljava/lang/String;)Lorg/schabi/newpipe/extractor/stream/DeliveryMethod;
    ...
    check-cast p0, Lorg/schabi/newpipe/extractor/stream/DeliveryMethod;
