...
.method public constructor <init>(Landroid/app/Application;Lorg/acra/config/CoreConfiguration;ZZZ)V
    ...
    .line 166
    new-instance v6, Lorg/acra/scheduler/SchedulerStarter;

    invoke-direct {v6, p1, p2}, Lorg/acra/scheduler/SchedulerStarter;-><init>(Landroid/content/Context;Lorg/acra/config/CoreConfiguration;)V

    iput-object v6, p0, Lorg/acra/reporter/ErrorReporterImpl;->schedulerStarter:Lorg/acra/scheduler/SchedulerStarter;

    .line 167
    new-instance v0, Lorg/acra/builder/ReportExecutor;
    ...
    iput-object v0, p0, Lorg/acra/reporter/ErrorReporterImpl;->reportExecutor:Lorg/acra/builder/ReportExecutor;

    .line 168
    invoke-virtual {v0, p3}, Lorg/acra/builder/ReportExecutor;->setEnabled(Z)V

    if-eqz p5, :cond_0

    .line 172
    new-instance p1, Lorg/acra/startup/StartupProcessorExecutor;

    invoke-direct {p1, v1, v2, v6}, Lorg/acra/startup/StartupProcessorExecutor;-><init>(Landroid/content/Context;Lorg/acra/config/CoreConfiguration;Lorg/acra/scheduler/SchedulerStarter;)V

    invoke-virtual {p1, p3}, Lorg/acra/startup/StartupProcessorExecutor;->processReports(Z)V
