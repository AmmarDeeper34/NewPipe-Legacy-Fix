...
.method private maybePollAndCheckTimestamp(J)V
    ...
    check-cast v9, Lcom/google/android/exoplayer2/audio/AudioTimestampPoller;

    .line 501
    invoke-virtual {v9, v5, v6}, Lcom/google/android/exoplayer2/audio/AudioTimestampPoller;->maybePollTimestamp(J)Z
    ...
    .line 506
    :cond_0
    invoke-virtual {v9}, Lcom/google/android/exoplayer2/audio/AudioTimestampPoller;->getTimestampSystemTimeUs()J

    move-result-wide v3

    .line 507
    invoke-virtual {v9}, Lcom/google/android/exoplayer2/audio/AudioTimestampPoller;->getTimestampPositionFrames()J
    ...
    invoke-interface/range {v0 .. v8}, Lcom/google/android/exoplayer2/audio/AudioTrackPositionTracker$Listener;->onSystemTimeUsMismatch(JJJJ)V

    .line 512
    invoke-virtual {v9}, Lcom/google/android/exoplayer2/audio/AudioTimestampPoller;->rejectTimestamp()V
    ...
    .line 514
    invoke-static {v1, v2, v0}, Lcom/google/android/exoplayer2/util/Util;->sampleCountToDurationUs(JI)J
    ...
    invoke-interface/range {v0 .. v8}, Lcom/google/android/exoplayer2/audio/AudioTrackPositionTracker$Listener;->onPositionFramesMismatch(JJJJ)V
    ...
    .line 520
    :cond_2
    invoke-virtual {v9}, Lcom/google/android/exoplayer2/audio/AudioTimestampPoller;->acceptTimestamp()V
