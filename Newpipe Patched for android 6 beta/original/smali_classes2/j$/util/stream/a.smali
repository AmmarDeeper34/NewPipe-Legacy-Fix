...
.method public constructor <init>(Lj$/util/stream/a;I)V
    ...
    invoke-static {p2, v1}, Lj$/util/stream/b7;->k(II)I
    ...
    .line 211
    invoke-virtual {p0}, Lj$/util/stream/a;->C0()Z
...
# virtual methods
.method public A0(Lj$/util/stream/u3;Lj$/util/Spliterator;Ljava/util/function/IntFunction;)Lj$/util/stream/d2;
    .locals 0
...
.method public B0(Lj$/util/stream/a;Lj$/util/Spliterator;)Lj$/util/Spliterator;
    ...
    .line 710
    invoke-virtual {p0, p1, p2, v0}, Lj$/util/stream/a;->A0(Lj$/util/stream/u3;Lj$/util/Spliterator;Ljava/util/function/IntFunction;)Lj$/util/stream/d2;
...
.method public abstract D0(ILj$/util/stream/m5;)Lj$/util/stream/m5;
.end method

.method public final E0(I)Lj$/util/Spliterator;
    .locals 6
    ...
    .line 422
    invoke-virtual {v2}, Lj$/util/stream/a;->C0()Z
    ...
    invoke-virtual {v3, v4}, Lj$/util/stream/b7;->u(I)Z
    ...
    .line 434
    :cond_0
    invoke-virtual {v2, v0, v1}, Lj$/util/stream/a;->B0(Lj$/util/stream/a;Lj$/util/Spliterator;)Lj$/util/Spliterator;
    ...
    invoke-static {v4, v0}, Lj$/util/stream/b7;->k(II)I
    ...
    invoke-static {p1, v0}, Lj$/util/stream/b7;->k(II)I
...
.method public final F0()Lj$/util/Spliterator;
    .locals 3
...
.method public abstract G0(Lj$/util/stream/a;Ljava/util/function/Supplier;Z)Lj$/util/Spliterator;
.end method
...
.method public final Z(Lj$/util/Spliterator;Lj$/util/stream/m5;)V
    ...
    .line 488
    :cond_0
    invoke-virtual {p0, p1, p2}, Lj$/util/stream/a;->a0(Lj$/util/Spliterator;Lj$/util/stream/m5;)Z

    return-void
.end method

.method public final a0(Lj$/util/Spliterator;Lj$/util/stream/m5;)Z
    .locals 3
    ...
    .line 502
    invoke-virtual {v0, p1, p2}, Lj$/util/stream/a;->y0(Lj$/util/Spliterator;Lj$/util/stream/m5;)Z
...
.method public final d0(Lj$/util/Spliterator;ZLjava/util/function/IntFunction;)Lj$/util/stream/d2;
    .locals 2
    ...
    .line 545
    invoke-virtual {p0, p0, p1, p2, p3}, Lj$/util/stream/a;->x0(Lj$/util/stream/a;Lj$/util/Spliterator;ZLjava/util/function/IntFunction;)Lj$/util/stream/d2;
    ...
    .line 549
    :cond_0
    invoke-virtual {p0, p1}, Lj$/util/stream/a;->e0(Lj$/util/Spliterator;)J

    move-result-wide v0

    .line 548
    invoke-virtual {p0, v0, v1, p3}, Lj$/util/stream/u3;->p0(JLjava/util/function/IntFunction;)Lj$/util/stream/v1;

    move-result-object p2

    .line 550
    invoke-virtual {p0, p1, p2}, Lj$/util/stream/a;->s0(Lj$/util/Spliterator;Lj$/util/stream/m5;)Lj$/util/stream/m5;

    invoke-interface {p2}, Lj$/util/stream/v1;->build()Lj$/util/stream/d2;
...
.method public final e0(Lj$/util/Spliterator;)J
    .locals 2
...
.method public final s0(Lj$/util/Spliterator;Lj$/util/stream/m5;)Lj$/util/stream/m5;
    .locals 1
    ...
    invoke-virtual {p0, v0}, Lj$/util/stream/a;->t0(Lj$/util/stream/m5;)Lj$/util/stream/m5;
...
.method public spliterator()Lj$/util/Spliterator;
    ...
    .line 367
    invoke-virtual {p0, p0, v1, v0}, Lj$/util/stream/a;->G0(Lj$/util/stream/a;Ljava/util/function/Supplier;Z)Lj$/util/Spliterator;
...
.method public final t0(Lj$/util/stream/m5;)Lj$/util/stream/m5;
    .locals 2
    ...
    invoke-virtual {v0, v1, p1}, Lj$/util/stream/a;->D0(ILj$/util/stream/m5;)Lj$/util/stream/m5;
...
.method public final u0(Lj$/util/Spliterator;)Lj$/util/Spliterator;
    .locals 2
    ...
    .line 534
    invoke-virtual {p0, p0, v0, p1}, Lj$/util/stream/a;->G0(Lj$/util/stream/a;Ljava/util/function/Supplier;Z)Lj$/util/Spliterator;
...
.method public final v0(Lj$/util/stream/j8;)Ljava/lang/Object;
    .locals 1
    ...
    .line 233
    invoke-interface {p1}, Lj$/util/stream/j8;->j()I

    move-result v0

    invoke-virtual {p0, v0}, Lj$/util/stream/a;->E0(I)Lj$/util/Spliterator;

    move-result-object v0

    invoke-interface {p1, p0, v0}, Lj$/util/stream/j8;->i(Lj$/util/stream/u3;Lj$/util/Spliterator;)Ljava/lang/Object;
...
.method public final w0(Ljava/util/function/IntFunction;)Lj$/util/stream/d2;
    .locals 3
    ...
    invoke-virtual {v0, v2}, Lj$/util/stream/a;->E0(I)Lj$/util/Spliterator;

    move-result-object v1

    invoke-virtual {p0, v0, v1, p1}, Lj$/util/stream/a;->A0(Lj$/util/stream/u3;Lj$/util/Spliterator;Ljava/util/function/IntFunction;)Lj$/util/stream/d2;
    ...
    .line 260
    :cond_0
    invoke-virtual {p0, v2}, Lj$/util/stream/a;->E0(I)Lj$/util/Spliterator;

    move-result-object v1

    invoke-virtual {p0, v1, v0, p1}, Lj$/util/stream/a;->d0(Lj$/util/Spliterator;ZLjava/util/function/IntFunction;)Lj$/util/stream/d2;
...
.method public abstract x0(Lj$/util/stream/a;Lj$/util/Spliterator;ZLjava/util/function/IntFunction;)Lj$/util/stream/d2;
.end method

.method public abstract y0(Lj$/util/Spliterator;Lj$/util/stream/m5;)Z
.end method

.method public abstract z0()Lj$/util/stream/c7;
.end method
